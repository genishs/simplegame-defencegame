...
> **검수 진행 누적 결함 (모두 fix 완료)**: #49 (spotlight 동그라미, rc.1→rc.2), #51 (튜토리얼 후 stage_01 frozen, rc.2→rc.3), #53 (entities render 누락 — 영웅/적 안 보임, rc.3→rc.4), **#55/#56/#57/#58 (게임플레이 인터랙션 4종 종합 fix, rc.4→차기 RC 대기, develop 머지 후 발급)**: 튜토리얼 곡식 클릭 / 아군 배치 UI / 영웅 자동 평타 / 수동 모드 영웅 전투 — DECISION-DL-P4D-007/008/009. pytest 누적 **472 → 490** (+18 회귀 가드).
