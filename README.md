...
**Phase 1 진행 중 — 역사 자료 조사 / 게임 컨셉 / 디자인 / 기술 검토 / 형상관리 인프라 구축**

| Phase | 내용 | 상태 |
|---|---|---|
| 1 | 사전 기획 — 역사 검토, 컨셉, 디자인 문서, 기술 아키텍처, SCM/CI 구축 | 진행 중 (v0.1.0) |
| 2 | 코어 게임플레이 프로토타입 (메인 루프, 타워, 적 이동, 웨이브) | 예정 |
| 3 | 스테이지/밸런싱 (5개 스테이지, 난이도 곡선) | 예정 |
| 4 | 그래픽/사운드/QA 폴리싱 | 예정 |
| 5 | 패키징/배포 베타 (PyInstaller 단일 .exe + GitHub Release) | 예정 |
