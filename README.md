...
**Phase 4 자동 가드 완결 — `v0.4.0-rc.1` 사전 릴리즈 (2026-05-19, SCM 발급). 사용자 검수(CAT-05) 진행 중 — 튜토리얼 spotlight 결함 #49 fix 완료 (PR #50 머지, develop@b7f0fc4, 2026-05-20). `v0.4.0` GA는 사용자 검수(CAT-01~07 + DPI 매트릭스) 최종 통과 후 별도 SCM 라운드에서 결정 (DECISION-SCM-P5K-001, RC2 발급 여부 포함).**
